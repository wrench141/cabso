            ...
            }
            {
                bill !== undefined ? (
                    <div className='section'>
                        ...
                        <p className='time'>Your Ride Timings {time}{bill.datetime.period} - {finalTime}{bill.datetime.period}</p>
                        ...
                        <button className='dbtn' onClick={() => setPopup(!popup)}>Cancel booking</button>
                        {
                            popup ? (
                                <div className='popupBg'>
                                    <div className='popup'>
                                        ...
                                        <p className='psub'>Are you sure to cancel your booking? click on confirm to cancel booking.</p>
                                        <div className='buttonContainer'>
                                            <button className='btn outline' onClick={() => setPopup(!popup)}>Close</button>
                                            <button onClick={() => {
